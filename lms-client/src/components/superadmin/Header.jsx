...
const Header = ({ collapsed, setCollapsed }) => {
  ...
  const [showSuperadminProfile, setShowSuperadminProfile] = useState(false); // ✅ state for popup
  ...
  return (
    <>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-sm font-medium hidden md:block">Superadmin User</span>
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 border border-gray-200 z-20">
                <div className="px-4 py-2 border-b border-gray-100">
                  <p className="text-sm font-medium">Superadmin User</p>
      ...
      {/* ✅ Render Superadmin Profile Popup */}
      {showSuperadminProfile && (
        <SuperAdminProfile onClose={() => setShowSuperadminProfile(false)} />
      )}
    </>
  );
};
