...
import { getUserProfile, updateSuperadminProfile } from "../../api/superadmin"; // ✅ Your API import

const SuperadminProfile = ({ onClose }) => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const updated = await updateSuperadminProfile(data); // ✅ Use imported API
      setUser(updated);
      setEditMode(false);
