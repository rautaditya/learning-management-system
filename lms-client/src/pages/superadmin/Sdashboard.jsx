...
import { LoaderCircle, Users, UserCheck, BookOpen, Video, FileText, MessageSquare, GraduationCap } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="relative  p-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <DashboardCard
            ...
            onClick={() => navigate('/superadmin/courses/manage')}
          ...
          <DashboardCard
            ...
            onClick={() => navigate('/superadmin/ManageVideo')}
          ...
          <DashboardCard
            ...
            onClick={() => navigate('/superadmin/assignment')}
          ...
          <DashboardCard
            ...
            onClick={() => navigate('/superadmin/contactdata')}
      ...
      <style jsx>{`
        ...
        .animate-slide-up-7 { animation: slide-up 0.6s ease-out 0.7s both; }
